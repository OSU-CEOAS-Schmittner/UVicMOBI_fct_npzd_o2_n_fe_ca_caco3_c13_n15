This is a working directory of UVic2.9/MOBI2.0 with flux corrected advection (fct), the basic npzd (nutrients, phytoplankton, zooplankton, detritus) ecosystem dynamics (npzd), oxygen (o2), nitrogen (n), iron (fe), carbon and alkalinity (ca), calcium carbonate (caco3), d13C (c13), and d15N (n15). See mk.in.
